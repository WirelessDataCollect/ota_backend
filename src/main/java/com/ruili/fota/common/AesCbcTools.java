//package com.terabits.watersupervision.util;
//
...
public class AesCbcTools {
     ...
     * @throws Exception
     */
    public static String decrypt(String data, String key, String iv, String encodingFormat) throws Exception {        //被加密的数据
